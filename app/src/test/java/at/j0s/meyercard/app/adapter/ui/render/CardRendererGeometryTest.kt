 ...
 * calls are covered by T2.4's screenshot tests, not here.
 */
class CardRendererGeometryTest {
     ...
     * already (T8's own earlier thrust-dot regression test only checked S). The fix moved
     * `Radius.INNER` to 0.32.
     */
    @Test
