 ...
 * on top of Train rather than being a peer of its own — matching docs/PLAN.md §7's screen
 * table, where Configure is reached from Train. docs/PLAN.md §7 also names a fourth,
 * standalone "Home" screen with its own title treatment; that's T7.1's job (original artwork),
