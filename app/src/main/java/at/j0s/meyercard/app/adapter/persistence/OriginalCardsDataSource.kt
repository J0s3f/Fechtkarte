 ...
 * schema per docs/PLAN.md §3.2) into domain [MeyerCard]s. Reading the asset
...
/**
 * The dataset's instruction strings are the manuscript's own wording,
 * not [Instruction]'s enum names — [Instruction]'s own doc comment is explicit
