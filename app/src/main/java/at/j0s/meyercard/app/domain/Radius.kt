 ...
 * one type — see DESIGN_CHOICES.md.
 */
@JvmInline
value class Radius(val value: Float) {
    ...
    companion object {
         ...
         * overlapping; see DESIGN_CHOICES.md. Legibility and edge-fidelity mattered more than
         * preserving the original 0.50 measurement exactly here — see the same entry.
         */
